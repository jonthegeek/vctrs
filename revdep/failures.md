...
* GitHub mirror: <https://github.com/cran/EIX>
...
*   checking whether package ‘EIX’ can be installed ... ERROR
     ```
     Installation failed.
     See ‘/tmp/workdir/EIX/new/EIX.Rcheck/00install.out’ for details.
     ```
...
** inst
** byte-compile and prepare package for lazy loading
Error: object ‘slice’ is not exported by 'namespace:xgboost'
Execution halted
ERROR: lazy loading failed for package ‘EIX’
* removing ‘/tmp/workdir/EIX/new/EIX.Rcheck/EIX’
...
Execution halted
ERROR: lazy loading failed for package ‘EIX’
* removing ‘/tmp/workdir/EIX/old/EIX.Rcheck/EIX’
